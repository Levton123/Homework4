...
2. Добавить Pikachu (№25) и Charizard (№6) в избранное — нажать ❤️ в списке или на экране деталей
...
> Замени *(скриншот)* на реальные скриншоты с эмулятора перед сдачей PR.
